			...
			<div class="small-7 medium-4 columns logo<?php if ($header_style == 'style1') { ?> show-for-large-up<?php } ?>">
				<?php if ($header_style == 'style2') { ?>
					<a href="<?php echo home_url(); ?>" class="logolink">
						<img src="<?php echo $logo; ?>" class="logo" alt="<?php bloginfo('name'); ?>"/>
					</a>
				<?php } ?>
			</div>
			<?php if ($header_style != 'style2') { ?>
				...
				<!-- <div class="nav-container">
					<ul id='nav'>
						<li class="level0 nav-1 first level-top parent">
							<a href="http://papayaart.com/whats-new.html">What's New</a>
						</li>

					</ul>
				</div> -->
<div id='top-links'><?php the_block('top.links'); ?></div>
                                <?php the_block('catalog.topnav'); ?>
				
				<!-- <div id='top-search'><?php the_block('top.search'); ?></div> 
