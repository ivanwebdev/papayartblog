...
?>
<?php if($sidebar != 'no') { ?>
    <article class="post product item grid-sizer small-12 medium-6 large-4 columns">
<?php } else { ?>
		<article class="post product item grid-sizer small-12 medium-6 large-3 columns">
<?php } ?>
