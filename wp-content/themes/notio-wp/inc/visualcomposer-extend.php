...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"description" => "If enabled, this will show an expand button on the map.",
		),
		array(
			"type" => "dropdown",
			"class" => "",
			...
			"description" => "This affects which side the map will grow.",
...
vc_map( array(
	...
	"params"	=> array(
	  ...
	  array(
	  	...
	  	"description" => "If enabled, this will cause the portfolio order to randomize. <strong>Load More functionality will not work with this.</strong>",
	  ),
	  array(
	      "type" => "checkbox",
	      "heading" => "Categories",
